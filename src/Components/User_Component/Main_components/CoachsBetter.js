    ...
    return (
        <>
            <View style={styles.titleContainer}>
                <Text style={styles.title}>مربیان برتر آژمان</Text>
            ...
            <ScrollView style={styles.container} horizontal showsHorizontalScrollIndicator={false}>

                {
                    typeof data.data !== 'undefined' ?
                        data.data.listCoachBetter.map((value, index) => {
                            return (
                                <View key={index} style={{ ...styles.card, width: width / 1.5, height: width }}>
                        ...
                        : Courses.map((value, index) => {
                            return (
                                <View key={index} style={{ ...styles.loadingCard, width: width / 1.5, height: width }} />
                            )
                        })
                }
            </ScrollView>
